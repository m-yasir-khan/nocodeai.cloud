import { InputText, HTML, Kanban, MaterialReciept, Withdrawal, KaizenBurst,
   TruckMovement, GoSee, ControlledFifo, Inventory, PushSystem, Inbox, FaxMachine} from "../Nodes";
