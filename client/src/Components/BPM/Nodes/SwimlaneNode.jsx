   ...
   // console.log(`item dropped on containe`, MyClass.staticProperty );
    ...
    return (
        ...
        <div className="flow-label">
            <div className='swimlane-node' style={{width:`${size?.x}px`,height:`${size.y}px`,opacity:'inherit'}}  onDrop={onDrop}>
         
            
            <div style={{background: data.backgroundColor,height: '100%',padding:'0px' ,writingMode:'vertical-rl'}}>
            <h3 style={{color: '#fff',transform:'rotate(180deg)'}} >{data.name}</h3>
            </div>
