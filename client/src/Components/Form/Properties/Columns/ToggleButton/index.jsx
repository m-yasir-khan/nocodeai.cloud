...
export default function ToggleButton(props) {
    ...
    const handleChange = (e) => {
        ...
        singleDataChange(e.target.value, props?.data?.id, 'button', props?.elements, props?.setElements)
      };
    return (
        <div className='properties'>
            ...
            <div visibility={props?.visibility?.toString()} className='properties-components'>
                ...
                <span>Name:</span>
                <input value={name} onChange={(e) => {setName(e.target.value); singleDataChange(e.target.value, props?.data?.id, "togglebutton", props?.elements, props?.setElements);}} type="text" />
                <span>Type:</span>
